...
namespace SFA.DAS.EmployerFinance.MessageHandlers.TestHarness.Startup
{
        ...
        public static IServiceCollection AddDasNServiceBus(this IServiceCollection services)
        {
            return services
                .AddSingleton(s =>
                {
                    ...
                    var endpointConfiguration = new EndpointConfiguration("SFA.DAS.EmployerFinanceV2.MessageHandlers.TestHarness")
