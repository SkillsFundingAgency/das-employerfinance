...
namespace SFA.DAS.EmployerFinance.UnitTests.Models
{
    ...
    public class UserTests : FluentTest<UserTestsFixture>
    {
        ...
        {
            Test(f => f.UpdateDefaultingToSame(email, firstName, lastName), f => f.AssertUpdated(email, firstName, lastName));
        }
    }
...
//        public void Update(string email = null, string firstName = null, string lastName = null)
//        {
...
//        }
        ...
        public void AssertUpdated(string expectedEmail = null, string expectedFirstName = null, string expectedLastName = null)
        {
